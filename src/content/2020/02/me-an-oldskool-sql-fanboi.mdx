...
description: 'Recently I came across this tweet of Steve O’Grady (he helped to found Redmonk, a research firm I really value highly)'
pubDate: 'Feb 04 2020'
categories: ['crate', 'technology', 'crate.io', 'nosql', 'sql']
heroImage: 'EOgzWXpXkAUM7fH.png'
heroImageAlt: 'A scatter plot of Wikipedia traffic for NoSQL from 2015 to 2020'
---
Recently I came across a [tweet](https://twitter.com/sogrady/status/1218280163089289216) of Steve O’Grady *(he helped to found Redmonk, a research firm I really value highly)*.

There he presented the above graph, which really stroke me. This is what I predicted 6 years ago. NoSQL isn’t the solution. And one of the main reasons we’ve built [CrateDB](https://crate.io/).
